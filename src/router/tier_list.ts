...
import {tier_list_create, tier_list_get, tier_lists, tier_list_update} from '../controllers/tier_list';
...
export default (router: express.Router) => {
    ...
    router.patch('/tierlist/edit/:id', mustBeLoggedIn, tier_list_update);
};